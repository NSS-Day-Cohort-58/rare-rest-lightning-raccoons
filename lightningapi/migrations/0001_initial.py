    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='lightningapi.category')),
            ],
        ),
        migrations.CreateModel(
            name='RareUser',
        ...
        migrations.AddField(
            model_name='post',
            name='tags',
            field=models.ManyToManyField(through='lightningapi.PostTag', to='lightningapi.tag'),
        ),
        migrations.AddField(
            model_name='post',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='lightningapi.rareuser'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
